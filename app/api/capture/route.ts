...
export async function POST(req: Request) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: "Briefing Bot <onboarding@resend.dev>", // Change to your domain once verified
      to: [userEmail],
      subject: `Intelligence Briefing: ${userQuery}`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1C1C1E;">
          ...
          <footer style="padding: 20px; text-align: center; border-top: 1px solid #EEE; font-size: 12px; color: #999;">
            <p>Generated by AI Automation Mum // Strategic Systems 2026</p>
          </footer>
        </div>
      `,
    });
