      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1C1C1E;">
          ...
          <div style="text-align: center; padding: 28px 24px; margin: 0 0 20px; background: #1C1C1E; border-radius: 8px;">
            ...
            <p style="font-size: 12px; color: #999; margin: 0 0 18px; line-height: 1.5;">This is an early demo — your feedback shapes what we build next. Tell us what worked and what didn't, and we'll send you <strong style="color: #ccc;">The Career DNA Interviewer</strong> — an AI prompt that explores your interests, strengths and goals to uncover what career actually fits you.</p>
